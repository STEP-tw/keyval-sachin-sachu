...
describe("parse basic key values",function(){
  ...
  it("parse when there are spaces after key",function(){
    let expected={key:"value"};
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("key =value")));
  });
...
describe("parse digits and other special chars",function(){
  ...
  it("parse keys with a single digit",function(){
    ...
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("1=value")));
  });

  it("parse keys with only multiple digits",function(){
    let expected={'123':"value"};
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("123=value")));
  });

  it("parse keys with leading 0s",function(){
    let expected={'0123':"value"};
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("0123=value")));
  });

  it("parse keys with underscores",function(){
    let expected={'first_name':"value"};
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("first_name=value")));
  });

  it("parse keys with a single underscore",function(){
    let expected={'_':"value"};
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("_=value")));
  });

  it("parse keys with multiple underscores",function(){
    let expected={'__':"value"};
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("__=value")));
  });

  it("parse keys with alphabets and digits(digits leading)",function(){
    let expected={'0abc':"value"};
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("0abc=value")));
  });

  it("parse keys with alphabets and digits(alphabets leading)",function(){
    let expected={'a0bc':"value"};
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("a0bc=value")));
  });
});
...
describe("multiple keys",function(){
  ...
  it("parse more than one key",function(){
    ...
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("key=value anotherkey=anothervalue")));
  });
...
describe("single values with quotes",function(){
  ...
  it("parse a single quoted value that has spaces in it",function(){
    ...
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("key=\"va lue\"")));
  });
...
describe("multiple values with quotes",function(){
  it("parse more than one value with quotes",function(){
    ...
    assert.deepEqual(Object.entries(expected),Object.entries(kvParser.parse("key=\"va lue\" anotherkey=\"another value\"")));
  });
...
describe("mixed values with both quotes and without",function(){
  ...
  it("parse simple values with and without quotes(quoted values first)",function(){
    let expected={key:"value",anotherkey:"anothervalue"};
    assert.sameDeepMembers(Object.entries(expected),Object.entries(kvParser.parse("anotherkey=\"anothervalue\" key=value")));
  });
});
...
describe("error handling",function(){
  ...
  it("throws error on missing value when value is unquoted",function(){
    try{
      ...
      assert.ok(errorChecker("key",3,MissingValueError));
    }
  });
  ...
  it("throws error on missing value when value is quoted",function(){
    try{
      ...
      assert.ok(errorChecker("key",9,MissingEndQuoteError));
    }
  });
  ...
  it("throws error on missing key",function(){
    try{
      ...
      assert.ok(errorChecker(undefined,0,MissingKeyError));
    }
  });
  ...
  it("throws error on missing assignment operator",function(){
      ...
      assert.ok(errorChecker(undefined,4,MissingAssignmentOperatorError));
      }
  });
  ...
  it("throws error on incomplete key value pair",function(){
    try{
      ...
      assert.ok(errorChecker(undefined,2,IncompleteKeyValuePairError));
    }
  });
